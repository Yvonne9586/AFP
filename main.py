...
def main():
    ...
    total_return, results_metrics = get_dynamic_result(tier3, total_return, results_metrics, "hrp_dd", " tier 3")
    print("========done with hrp with mdd=========")
    # calculate benchmark 3: traditional risk-parity with tier 2
    total_return, results_metrics = get_dynamic_result(tier3, total_return, results_metrics, "risk_parity", " tier 2")
    print("========done with traditional risk-parity with tier 2 assets=========")
    # calculate equal risk weight: equal risk-parity with tier 2
    total_return, results_metrics = get_dynamic_result(tier3, total_return, results_metrics, "equal_risk_parity", " tier 2")
    print("========done with traditional risk-parity with tier 2 assets=========")

    # calculate benchmark 4: traditional risk-parity with tier 3
    total_return, results_metrics = get_dynamic_result(tier3, total_return, results_metrics, "risk_parity", " tier 3")
    print("========done with traditional risk-parity with tier 3 assets=========")

    # calculate benchmark 1: 60/40 equity_bond
    total_return, results_metrics = get_static_benchmark(tier3, total_return, results_metrics, "equity_bond", " tier 1")
    print("========done with 60/40=========")
    # calculate benchmark 2: all weather
    total_return, results_metrics = get_static_benchmark(tier2, total_return, results_metrics, "all_weather", " tier 2")
